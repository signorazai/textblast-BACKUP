    ...
    <div class="bg-white w-73 flex flex-col justify-between fixed h-full z-50">
        ...
        <div>
            ...
            <div class="flex items-center justify-center w-full my-10">
                ...
                <div class="ml-2 px-2 py-1 h-6 text-black font-semibold text-xs rounded"
                    style="background-color: #C3CBDC;">
                    edu
                </div>
                <div class="relative">
                    ...
                    <div id="dropdown" class="absolute right-0 mt-2 w-48 bg-white border rounded shadow-lg hidden">
                        ...
                        <button onclick="setTheme('rosyred')" class="dropdown-item text-gray-800 hover:bg-gray-200">Rosy
                            Red</button>
                        <button onclick="setTheme('slimegreen')"
                            class="dropdown-item text-gray-800 hover:bg-gray-200">Slime Green</button>
