    ...
    <div class="bg-white p-6 rounded-lg shadow-lg">
        ...
        <div class="mb-4">
            <div class="flex border-b border-gray-300">
                ...
                <button type="button" class="tab-button px-4 py-2 text-sm font-medium text-gray-500 focus:outline-none" data-value="importData">
                    IMPORT OPTIONS
                </button>
            </div>
        </div>
        ...
        <div id="importData" class="tab-content hidden">
            <div class="container mx-auto">
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    ...
                    <div class="space-y-4">
                        <button type="button" onclick="openModal('collegeImportModal')" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition duration-200 ease-in-out w-full">
                            Import College
                        </button>

                        <button type="button" onclick="openModal('programImportModal')" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition duration-200 ease-in-out w-full">
                            Import Program
                        </button>

                        <button type="button" onclick="openModal('majorImportModal')" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition duration-200 ease-in-out w-full">
                            Import Major
                        </button>

                        <button type="button" onclick="openModal('yearImportModal')" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition duration-200 ease-in-out w-full">
                            Import Year
                        </button>
                    </div>
                </div>
