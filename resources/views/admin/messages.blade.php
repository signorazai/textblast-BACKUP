...
<div class="bg-white p-6 rounded-lg shadow-md">
    ...
    <form action="{{ route('admin.reviewMessage') }}" method="POST">
        ...
        <div class="flex justify-end items-center mb-4">
            <span id="total_recipients" class="text-sm font-medium text-gray-700">Total recipients: </span>
        </div>
        ...
        <!-- <div class="mb-4">
            ...
            <div class="flex items-center mt-2">
                <input type="radio" id="immediate" name="schedule" value="immediate" checked>
                <label for="immediate" class="ml-2">Send Now</label>
            </div>
            <div class="flex items-center mt-2">
                <input type="radio" id="scheduled" name="schedule" value="scheduled">
                <label for="scheduled" class="ml-2">Send Later</label>
            </div>
        </div> -->
        ...
        <div class="mb-4 flex items-center">
            ...
            <!-- Date and Time Picker for Scheduling -->
            <div id="schedule-options" style="display: none;" class="flex items-center ml-6">
                <label for="scheduled_date" class="block text-sm font-medium text-gray-700 mb-2">Select Date and Time:</label>
                <input type="datetime-local" id="scheduled_date" name="scheduled_date"
